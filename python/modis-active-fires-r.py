...
if __name__ == '__main__':
	...
	mydir		= os.path.join(config.MODIS_ACTIVE_FIRES_RCMRD, str(year),doy, regionName)
	...
	s3_folder	= os.path.join("modis_af_rcmrd", str(year), doy)
	s3_bucket	= region['bucket']
	bbox		= region['bbox']
	zoom		= region['thn_zoom']

	filename 	= "MOD14.%d%s.txt" % (year, doy)
